# This script performs pariwise comparison between subgroups for regional
# measures strength, degree, and participation coefficient and plots these
# differences as boxplots for each significant region.
